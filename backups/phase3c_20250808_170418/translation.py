...
def translate_chatgpt():
    ...
    try:
        ...
        # TranslationContext保存（インタラクティブ質問用）
        from translation.context_manager import TranslationContext
        translations = {
            "chatgpt": translated,
        ...
        TranslationContext.save_context(input_text, translations, "", metadata)
